...
<c:set var="pageTitle" value="Đơn đã xác nhận" scope="request" />
...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <h5 class="pe-3">Đơn hàng đã xác nhận</h5>
        </div>
                            ...
                            <c:forEach var="customer_order" items="${customer_orders}">
                                <tr id="order-row-${customer_order.id}">
                                    ...
                                    <td class="text-center" width="15%">
                                        ...
                                        <button type="button" class="btn btn-danger btn-cancel-order" data-order-id="${customer_order.id}" data-bs-toggle="modal" data-bs-target="#cancel_order_${customer_order.id}" title="Huỷ đơn">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-cancel-order-confirmed').click(function() {
            ...
            $.post('/admin/cancel-order-confirmed', {orderId: orderId, reason: reason}, function(res) {
                if (res === 'success') {
